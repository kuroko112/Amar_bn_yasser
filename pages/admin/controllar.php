...
<div class="backgound">
  ...
  <?php 
    ...
    if(isset($_SESSION['username']) && $row['GropID'] == 1)
    {
        ...
        ?>
      <div id="container">
        <h1 style="text-align:center;color:white">تــــــقــــريــــــر الخــــــاصــة بشـــــــؤن عــــــــامــــلــــيــــن</h1>
        ...
        <?php 
            ...
            {
              header("LOCATION: show_org.php");
              exit();
            }
            if(isset($_POST['er_day']))
            {
              header("LOCATION: error_day.php");
            }
            ...
            {
              header("LOCATION: Statistic_today.php");
            }
