<?php 
    ...
    $job                    = $row['teac_job' ] ;
    $org_com                = $row['org_com'  ] ;
    $teac_phone             = $row['teac_phone'];
    $teac_address           = $row['teac_address'];
    // -----------------------------------< birthday >---------------------------
    $birthday               = explode("/", $row['birthday']);
    $day_birthday           = $birthday[0];
    $month_birthday         = $birthday[1];
    $year_birthday          = $birthday[2];
    // ---------------------------------------------------------------------------

    // -----------------------------------< date_hiring >--------------------------
    $date_hiring            = explode("/", $row['date_hiring']);
    $day_date_hiring        = $date_hiring[0];
    $month_date_hiring      = $date_hiring[1];
    $year_date_hiring       = $date_hiring[2];
    // ----------------------------------------------------------------------------

    // -----------------------------------< date_work >----------------------------
    $date_work            = explode("/", $row['date_work']);
    $day_date_work        = $date_work[0];
    $month_date_work      = $date_work[1];
    $year_date_work       = $date_work[2];
    // ----------------------------------------------------------------------------

    // ------------------------------------< date_up > -----------------------------
    $date_up            = explode("/", $row['date_up']);
    $day_date_up        = $date_up[0];
    $month_date_up      = $date_up[1];
    $year_date_up       = $date_up[2];
    // ---------------------------------------------------------------------------
    ...
    ?>
        ...
        <html>
          ...
          <body>
            ...
            <form action="update_data_org.php?id=<?php echo $tea_id?>" method="GET">
              <h1 style="text-align:center;">تــــــــعـــــــديـــــــــل مدرس</h1>
              <fieldset>
                <legend>
                  <h3>البيانات الاساسية</h3>
                </legend>
                <div  class="account-details">
                  <div><label>الاسم</label><input type="text" name="teac_name" value="<?php echo  $name?>" ></div>
                  <div><input type="hidden" name="id" value="<?php echo  $tea_id?>" ></div>
                  <div>
                  ...
                  <div><label>العنوان</label><input         type="text" name="teac_address" value="<?php echo $teac_address?>" ></div>
                  <div><label>الرقم القومي</label><input    type="text" name="national_id"  value="<?php echo $national_id?>" ></div>
                  <div><label>الموبيل</label><input         type="text" name="teac_phone"    value="<?php echo $teac_phone?>" ></div>
                  
                  <div><label>درجة المعلم</label>
                   <select name="tea_grade">
                      <option value="<?php echo $tea_grade?>"><?php echo $tea_grade?></option>
                 ...
                 <div><label>حالة المعلم</label>
                  <select name="org_com">
                      <option value="<?php echo $org_com?>"><?php echo $org_com?></option>
                    ...
                    <div class="birthdate">
                      ...
                      <div class="bdate-block">
                        <select class="day"  name="day_hiring">
                          <option value="<?php echo $day_date_hiring?>"><?php echo $day_date_hiring?></option>
                        ...
                        <select class="mounth" name="mounth_hiring" >
                          <option value="<?php echo $month_date_hiring?>"><?php echo $month_date_hiring?></option>
                        ...
                        <input type="text" name="year_hiring" value="<?php echo $year_date_hiring?>"  placeholder="السنة">
                      </div>
                    </div>
                    ...
                    <div class="birthdate">
                      ...
                      <div class="bdate-block">
                        <select class="day"  name="day_up">
                          <option value="<?php echo $day_date_up?>"><?php echo $day_date_up?></option>
                          <option value="01">01</option>
                          <option value="02">02</option>
                          <option value="03">03</option>
                          <option value="04">04</option>
                        ...
                        <select class="mounth" name="mounth_up" >
                          <option value="<?php echo $month_date_up?>"><?php echo $month_date_up?></option>
                          <option value="1">January</option>
                          <option value="2">February</option>
                          <option value="3">March</option>
                          <option value="4">April</option>
                        ...
                        <input type="text" name="year_up" value="<?php echo $year_date_up?>"  placeholder="السنة">
                      </div>
                    </div>
                    ...
                    <div class="birthdate">
                      ...
                      <div class="bdate-block">
                        <select class="day"  name="day">
                          <option value="<?php echo $day_birthday?>"><?php echo $day_birthday?></option>
                          <option value="01">01</option>
                          <option value="02">02</option>
                          <option value="03">03</option>
                          <option value="04">04</option>
                        ...
                        <option value="<?php echo $month_birthday?>"><?php echo $month_birthday?></option>
                          <option value="1">January</option>
                          <option value="2">February</option>
                          <option value="3">March</option>
                          <option value="4">April</option>
                        ...
                        <input type="text" name="year" value="<?php echo $year_birthday?>" placeholder="السنة">
                      </div>
                    </div>
                    ...
                    <div class="birthdate">
                      ...
                      <div class="bdate-block">
                        <select class="day"  name="day_work">
                          <option value="<?php echo $day_date_work?>"><?php echo $day_date_work?></option>
                          <option value="01">01</option>
                          <option value="02">02</option>
                          <option value="03">03</option>
                          <option value="04">04</option>
                        ...
                        <select class="mounth" name="mounth_work" >
                          <option value="<?php echo $month_date_work?>"><?php echo $month_date_work?></option>
                          <option value="1">January</option>
                          <option value="2">February</option>
                          <option value="3">March</option>
                          <option value="4">April</option>
                        ...
                        <input type="text" name="year_work" value="<?php echo $year_date_work?>" placeholder="السنة">
                      </div>
                    </div>
              ...
              <button type="submit">ســــــجــــل البيانات</button>
              <dive class="link">
