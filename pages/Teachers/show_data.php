...
<html style="text-align:right;">
    ...
    <h1 style="text-align:center">المــــنــتــدبــيــن بالــمــدرســــة</h1>    
    ...
    if(isset($_SESSION['username']) && $row['GropID'] == 2)
    {
        ...
        $row          = mysqli_fetch_assoc($result);
        $id_admin     = $row['GropID'];
        $query_data   = "SELECT * FROM teacher where teacher.org_com = 'منتدب' ORDER BY `teacher`.`teac_name` ASC";
        ...
        <table class="table table-bordered; text-align:right">
            ...
            {   
                ...
                ?> 
                <tr>
				    <td><a href="delegate.php?id=<?php echo $row['tea_id']; ?>">سجل الايام من هنا</a></td>
