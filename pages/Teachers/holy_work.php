...
<html style="text-align:right;">
    ...
    <h1 style="text-align:center">تـــــــــســـجــــيـــــــل حــــضـــور و غــيـــــاب</h1>    
    ...
    if(isset($_SESSION['username']) && $row['GropID'] == 2)
    {
        ...
        <table class="table table-bordered; text-align:right">
            ...
            {   
                ...
                ?> 
                <tr>
				    <td><a href="hodor.php?id=<?php echo $row['tea_id']; ?>">ســــجـــل الحـــضـــور  </a></td>
