...
<html style="text-align:right;">
    ...
    <h1 style="text-align:center">الاصــلـــــــي بالــمــدرســــة</h1>    
    ...
    if(isset($_SESSION['username']) && $row['GropID'] == 2)
    {
        ...
        $row          = mysqli_fetch_assoc($result);
        $id_admin     = $row['GropID'];
        $query_data   = "SELECT * FROM teacher where teacher.org_com = 'اصلي' ORDER BY `teacher`.`teac_name` ASC";
